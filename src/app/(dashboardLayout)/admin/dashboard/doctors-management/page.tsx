...
export default async function DoctorsManagementPage({searchParams}: {searchParams: Promise<{[key: string]: string | string[] | undefined}>}) {
    ...
    return (
        <HydrationBoundary state={dehydrate(queryClient)}>
            ...
            {/* Doctors List */}
            <DoctorsTable searchParams={params} />
        </HydrationBoundary>
    )
}